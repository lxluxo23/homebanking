...
public class HomebankingApplication {
    ...
    public CommandLineRunner initData(
			...
			CoordinateCardRepository coordinateCardRepository
			) {
        return (args) -> {
			...
			*/
			...
			CoordinateCard cordCard1 = new CoordinateCard(melba);
			CoordinateCard cordCard2 = new CoordinateCard(luis);
			CoordinateCard cordCard3 = new CoordinateCard(admin);

			coordinateCardRepository.save(cordCard1);
			coordinateCardRepository.save(cordCard2);
			coordinateCardRepository.save(cordCard3);
